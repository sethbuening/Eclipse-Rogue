...
## If true, this enemy only spawns while the player is forging.
## It will never appear in the normal roster.
...
## Flat armor ignored when this enemy deals damage.
...
@export var buff_interval:       float = 2.0
